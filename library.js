...
OAuth.parseUserReturn = function (data, callback) {
	...
	const profile = {};
    // .data.attributes looks into the JSONAPI repsonse body
	profile.id = data.data.attributes.userId;
	profile.displayName = data.data.attributes.userName;
	profile.emails = [{ value: data.data.attributes.email }];
    profile.isAdmin = data.data.attributes.groups.indexOf('faf_server_administrators') > -1;
